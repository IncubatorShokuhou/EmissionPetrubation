...
!     netCDF file './origin/1level/wrfchemi_d01_2016-11-01_00:00:00.nc' into memory.
!  
!  History: 
!  Date       Name          Action
!-------------------------------------------------------
...
! Open netCDF file.
      status=nf_open('./origin/1level/wrfchemi_d01_2016-11-01_00:00:00.nc',nf_nowrite,ncid)
